  ...
  for (const singleService of Services) {
    ...
    if (Elservices_container) {
      Elservices_container.innerHTML += `
          <div id="${singleService.fca_id}" class="col-sm-9 col-md-6 col-lg-4 mb-4">
          <a onclick="loadFocusARea('${singleService.fca_id}')" href="focus-area-detail.html" class="custom-link-hover-effects text-decoration-none" data-cursor-effect-hover="plus">
              <div class="card box-shadow-4">
                  <div class="card-img-top position-relative overlay overlay-show">
                      <div class="position-absolute bottom-0 left-0 w-100 py-3 px-4 z-index-3">
                          <h4 class="font-weight-semibold text-color-light text-6 mb-1">${singleService.fca_heading}</h4>
  
                      </div>
                      <img src="img/foucusAreas/services-1.jpg" class="img-fluid" alt="${singleService.fca_heading}" />
                  </div>
                  <div class="card-body d-flex align-items-center custom-view-more px-4">
                  <p class="card-text w-100 mb-0">${singleService.fca_short_desc} </p>
