...
const ElTM_detail_memberEducation = document.getElementById(
  "TM_detail_memberEducation"
);
const ElTM_detail_memberExperience = document.getElementById(
  "TM_detail_memberExperience"
);
const ELTM_detail_memberAcadProf = document.getElementById(
  "TM_detail_memberAcadProf"
);
const ElTM_detail_memberRsrchInt = document.getElementById(
  "TM_detail_memberRsrchInt"
);
const ElTM_detail_memberReprPublications = document.getElementById(
  "TM_detail_memberReprPublications"
);
const ElTM_detail_memberContactInfoEMail = document.getElementById(
  "TM_detail_memberContactInfoEMail"
);
const ElTM_detail_memberContactInfoPhone = document.getElementById(
  "TM_detail_memberContactInfoPhone"
);
...
for (const singleMember of teamMembers) {
  if (ELTM_detail_memberHeading) {
    if (singleMember.member_id == teamMember) {
      ...
      ElTM_detail_memberContactInfoEMail.href = `mailto:${singleMember.member_email}`;
      ElTM_detail_memberContactInfoEMail.textContent = `${singleMember.member_email}`;
      ElTM_detail_memberContactInfoPhone.href = `tel:${singleMember.member_Phone}`;
      ElTM_detail_memberContactInfoPhone.textContent = `${singleMember.member_Phone}`;
