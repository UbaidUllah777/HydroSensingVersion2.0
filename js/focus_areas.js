...
// *** Getting Focus Area Container from Index Page  and Focus Area page and sending Focus Areas***

const Elfocus_areas_container = document.getElementById(
...
document.addEventListener("DOMContentLoaded", function () {
  for (const focus_area of focusAreas) {
    ...
    if (Elfocus_areas_container) {
      Elfocus_areas_container.innerHTML += `
        <div id="${focus_area.fca_id}" class="col-sm-9 col-md-6 col-lg-4 mb-4">
        <a onclick="loadFocusARea('${focus_area.fca_id}')" href="focus-area-detail.html" class="custom-link-hover-effects text-decoration-none" data-cursor-effect-hover="plus">
